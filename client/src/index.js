    ...
    <div className="pg-wrapper pg-vertical">
      <div id="container" className="pg-container">
        <div
          data-anchor="page-1"
          id="page-1"
          className="pg-page pg-active"
        ></div>
        <div data-anchor="page-2" id="page-2" className="pg-page"></div>
        <div data-anchor="page-3" id="page-3" className="pg-page"></div>
        <div data-anchor="page-4" id="page-4" className="pg-page"></div>
      </div>
    </div>
  </React.StrictMode>
);
